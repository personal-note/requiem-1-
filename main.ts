...
function startlevel () {
    if (level == 0) {
        ...
        tiles.coverAllTiles(tiles.util.door0, assets.tile`myTile7`)
        spawncombat()
    } else if (level == 1) {
...
game.onUpdate(function () {
    if (level == 3) {
        if ((player1.isHittingTile(CollisionDirection.Left) || player1.isHittingTile(CollisionDirection.Right)) && player1.vy > 0) {
            player1.vy = 0
            player1.ay = 0
            if (character.matchesRule(player1, character.rule(Predicate.HittingWallLeft))) {
                animation.runImageAnimation(
                player1,
                [img`
                    ...................
            ...
            } else if (character.matchesRule(player1, character.rule(Predicate.HittingWallRight))) {
                animation.runImageAnimation(
                player1,
                [img`
                    ...................
